...
namespace FarrokhGames.Inventory
{
        ...
        IInventoryController
    {
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            // Get which item to drag (item will be null if none were found)
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            {
                Debug.LogWarning("No item to drag or already dragging an item.", this);
                return;
            }
        ...
        public static InventoryDraggedItem GetDraggedItem()
        {
            return _draggedItem;
        }
        ...
        public static void ClearDraggedItem()
        {
            if (_draggedItem != null)
            {
                _draggedItem.Drop(Vector2.zero); // Force drop or return to original position
                _draggedItem = null;
            }
        }

        public static void SetDraggedItem(InventoryDraggedItem draggedItem)
        {
